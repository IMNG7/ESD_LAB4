      ...
      00044A                        659 _inttostr_a_65536_11:
      00044A                        660 	.ds 1
                           000001   661 LTimer.inttostr$b$1_0$12==.
      00044B                        662 _inttostr_b_65536_12:
      00044B                        663 	.ds 3
                                    664 ;--------------------------------------------------------
                           ...
                           000000   702 	C$Timer.c$22$0_0$10 ==.
                                    703 ;	Timer.c:22: void timer_init()
                                    704 ;	-----------------------------------------
                                    705 ;	 function timer_init
                                    706 ;	-----------------------------------------
      002BC3                        707 _timer_init:
                           000007   708 	ar7 = 0x07
                           000006   709 	ar6 = 0x06
                           000005   710 	ar5 = 0x05
                           000004   711 	ar4 = 0x04
                           ...
                           000001   714 	ar1 = 0x01
                           000000   715 	ar0 = 0x00
                           000000   716 	C$Timer.c$25$1_0$10 ==.
                                    717 ;	Timer.c:25: TMOD|=0x01;
      002BC3 43 89 01         [24]  718 	orl	_TMOD,#0x01
                           000003   719 	C$Timer.c$27$1_0$10 ==.
                                    720 ;	Timer.c:27: TH0=0x4B;       // timer values for getting overflow in 50ms
      002BC6 75 8C 4B         [24]  721 	mov	_TH0,#0x4b
                           000006   722 	C$Timer.c$28$1_0$10 ==.
                                    723 ;	Timer.c:28: TL0=0xFC;
      002BC9 75 8A FC         [24]  724 	mov	_TL0,#0xfc
                           000009   725 	C$Timer.c$29$1_0$10 ==.
                                    726 ;	Timer.c:29: TR0=1;          //starting timer
                                    727 ;	assignBit
      002BCC D2 8C            [12]  728 	setb	_TR0
                           00000B   729 	C$Timer.c$30$1_0$10 ==.
                                    730 ;	Timer.c:30: ET0|=1;         //starting timer interrupt
      002BCE 7F 01            [12]  731 	mov	r7,#0x01
      002BD0 A2 A9            [12]  732 	mov	c,_ET0
                                    733 ;	assignBit
      002BD2 EF               [12]  734 	mov	a,r7
      002BD3 24 FF            [12]  735 	add	a,#0xff
      002BD5 92 A9            [24]  736 	mov	_ET0,c
                           000014   737 	C$Timer.c$31$1_0$10 ==.
                                    738 ;	Timer.c:31: EA|=1;          //Enabling the interrupt
      002BD7 7F 01            [12]  739 	mov	r7,#0x01
      002BD9 A2 AF            [12]  740 	mov	c,_EA
                                    741 ;	assignBit
      002BDB EF               [12]  742 	mov	a,r7
      002BDC 24 FF            [12]  743 	add	a,#0xff
      002BDE 92 AF            [24]  744 	mov	_EA,c
                           00001D   745 	C$Timer.c$32$1_0$10 ==.
                                    746 ;	Timer.c:32: }
                           00001D   747 	C$Timer.c$32$1_0$10 ==.
                           00001D   748 	XG$timer_init$0$0 ==.
      002BE0 22               [24]  749 	ret
                                    750 ;------------------------------------------------------------
                           ...
                           00001E   759 	C$Timer.c$38$1_0$12 ==.
                                    760 ;	Timer.c:38: void inttostr(uint8_t a)
                                    761 ;	-----------------------------------------
                                    762 ;	 function inttostr
                                    763 ;	-----------------------------------------
      002BE1                        764 _inttostr:
      002BE1 E5 82            [12]  765 	mov	a,dpl
      002BE3 90 04 4A         [24]  766 	mov	dptr,#_inttostr_a_65536_11
      002BE6 F0               [24]  767 	movx	@dptr,a
                           000024   768 	C$Timer.c$40$2_0$13 ==.
                                    769 ;	Timer.c:40: while(a!=0)
      002BE7 7F 02            [12]  770 	mov	r7,#0x02
      002BE9                        771 00101$:
      002BE9 90 04 4A         [24]  772 	mov	dptr,#_inttostr_a_65536_11
      002BEC E0               [24]  773 	movx	a,@dptr
      002BED FE               [12]  774 	mov	r6,a
      002BEE E0               [24]  775 	movx	a,@dptr
      002BEF 60 54            [24]  776 	jz	00103$
                           00002E   777 	C$Timer.c$41$2_0$13 ==.
                                    778 ;	Timer.c:41: {   i--;
      002BF1 1F               [12]  779 	dec	r7
                           00002F   780 	C$Timer.c$42$2_0$13 ==.
                                    781 ;	Timer.c:42: b[i]=(a%10)+'0';        //Start from the last and go till first
      002BF2 EF               [12]  782 	mov	a,r7
      002BF3 24 4B            [12]  783 	add	a,#_inttostr_b_65536_12
      002BF5 FC               [12]  784 	mov	r4,a
      002BF6 E4               [12]  785 	clr	a
      002BF7 34 04            [12]  786 	addc	a,#(_inttostr_b_65536_12 >> 8)
      002BF9 FD               [12]  787 	mov	r5,a
      002BFA 7B 00            [12]  788 	mov	r3,#0x00
      002BFC 90 04 50         [24]  789 	mov	dptr,#__modsint_PARM_2
      002BFF 74 0A            [12]  790 	mov	a,#0x0a
      002C01 F0               [24]  791 	movx	@dptr,a
      002C02 E4               [12]  792 	clr	a
      002C03 A3               [24]  793 	inc	dptr
      002C04 F0               [24]  794 	movx	@dptr,a
      002C05 8E 82            [24]  795 	mov	dpl,r6
      002C07 8B 83            [24]  796 	mov	dph,r3
      002C09 C0 07            [24]  797 	push	ar7
      002C0B C0 06            [24]  798 	push	ar6
      002C0D C0 05            [24]  799 	push	ar5
      002C0F C0 04            [24]  800 	push	ar4
      002C11 C0 03            [24]  801 	push	ar3
      002C13 12 2D A8         [24]  802 	lcall	__modsint
      002C16 A9 82            [24]  803 	mov	r1,dpl
      002C18 D0 03            [24]  804 	pop	ar3
      002C1A D0 04            [24]  805 	pop	ar4
      002C1C D0 05            [24]  806 	pop	ar5
      002C1E D0 06            [24]  807 	pop	ar6
      002C20 74 30            [12]  808 	mov	a,#0x30
      002C22 29               [12]  809 	add	a,r1
      002C23 8C 82            [24]  810 	mov	dpl,r4
      002C25 8D 83            [24]  811 	mov	dph,r5
      002C27 F0               [24]  812 	movx	@dptr,a
                           000065   813 	C$Timer.c$43$1_0$12 ==.
                                    814 ;	Timer.c:43: a=a/10;
      002C28 90 04 59         [24]  815 	mov	dptr,#__divsint_PARM_2
      002C2B 74 0A            [12]  816 	mov	a,#0x0a
      002C2D F0               [24]  817 	movx	@dptr,a
      002C2E E4               [12]  818 	clr	a
      002C2F A3               [24]  819 	inc	dptr
      002C30 F0               [24]  820 	movx	@dptr,a
      002C31 8E 82            [24]  821 	mov	dpl,r6
      002C33 8B 83            [24]  822 	mov	dph,r3
      002C35 12 2E BC         [24]  823 	lcall	__divsint
      002C38 AD 82            [24]  824 	mov	r5,dpl
      002C3A AE 83            [24]  825 	mov	r6,dph
      002C3C D0 07            [24]  826 	pop	ar7
      002C3E 90 04 4A         [24]  827 	mov	dptr,#_inttostr_a_65536_11
      002C41 ED               [12]  828 	mov	a,r5
      002C42 F0               [24]  829 	movx	@dptr,a
      002C43 80 A4            [24]  830 	sjmp	00101$
      002C45                        831 00103$:
                           000082   832 	C$Timer.c$45$3_0$15 ==.
                                    833 ;	Timer.c:45: for(j=0;j<i;j++)
      002C45 7E 00            [12]  834 	mov	r6,#0x00
      002C47                        835 00106$:
      002C47 C3               [12]  836 	clr	c
      002C48 EE               [12]  837 	mov	a,r6
      002C49 9F               [12]  838 	subb	a,r7
      002C4A 50 10            [24]  839 	jnc	00104$
                           000089   840 	C$Timer.c$46$3_0$15 ==.
                                    841 ;	Timer.c:46: {   b[j]='0';               // give the first few values zero
      002C4C EE               [12]  842 	mov	a,r6
      002C4D 24 4B            [12]  843 	add	a,#_inttostr_b_65536_12
      002C4F F5 82            [12]  844 	mov	dpl,a
      002C51 E4               [12]  845 	clr	a
      002C52 34 04            [12]  846 	addc	a,#(_inttostr_b_65536_12 >> 8)
      002C54 F5 83            [12]  847 	mov	dph,a
      002C56 74 30            [12]  848 	mov	a,#0x30
      002C58 F0               [24]  849 	movx	@dptr,a
                           000096   850 	C$Timer.c$45$2_0$14 ==.
                                    851 ;	Timer.c:45: for(j=0;j<i;j++)
      002C59 0E               [12]  852 	inc	r6
      002C5A 80 EB            [24]  853 	sjmp	00106$
      002C5C                        854 00104$:
                           000099   855 	C$Timer.c$48$1_0$12 ==.
                                    856 ;	Timer.c:48: lcdbusywait();
      002C5C 12 22 6D         [24]  857 	lcall	_lcdbusywait
                           00009C   858 	C$Timer.c$49$1_0$12 ==.
                                    859 ;	Timer.c:49: LCD_putstr(b);
      002C5F 90 04 4B         [24]  860 	mov	dptr,#_inttostr_b_65536_12
      002C62 12 23 AD         [24]  861 	lcall	_LCD_putstr
                           0000A2   862 	C$Timer.c$50$1_0$12 ==.
                                    863 ;	Timer.c:50: lcdbusywait();
      002C65 12 22 6D         [24]  864 	lcall	_lcdbusywait
                           0000A5   865 	C$Timer.c$51$1_0$12 ==.
                                    866 ;	Timer.c:51: DR_WRITE=':';
      002C68 90 F1 00         [24]  867 	mov	dptr,#_DR_WRITE
      002C6B 74 3A            [12]  868 	mov	a,#0x3a
      002C6D F0               [24]  869 	movx	@dptr,a
                           0000AB   870 	C$Timer.c$52$1_0$12 ==.
                                    871 ;	Timer.c:52: }
                           0000AB   872 	C$Timer.c$52$1_0$12 ==.
                           0000AB   873 	XG$inttostr$0$0 ==.
      002C6E 22               [24]  874 	ret
                                    875 	.area CSEG    (CODE)
                                    876 	.area CONST   (CODE)
                                    877 	.area XINIT   (CODE)
