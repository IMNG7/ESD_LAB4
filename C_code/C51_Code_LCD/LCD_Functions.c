...
__xdata __at (0xF200) volatile unsigned char IR_Read;
...
/* Name: lcd_gotoaddr()
 Description: Sets the cursor to the specified LCD DDRAM address.
  Inputs: Row and column address to be given
 Returns: void
.*/
...
{   column_pos=column;
    ...
    case 1: lcd_gotoaddr(column);
            break;
    case 2: lcd_gotoaddr(63+column);        //Got the values of the addresses through trial and error method
            break;
...
/* Name: ddram_dump()
 Description: Dump the values of the DDRAM contents
  Inputs: none
 Returns: void
.*/
void ddram_dump()
